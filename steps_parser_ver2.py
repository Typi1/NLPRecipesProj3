...
verbs_to_tools = {'freeze': 'freezer', 'refrigerate':'refrigerator', 'chill':'refrigerator', 'grate':'grater','blend':'blender', 'fry':'stove', 'bake':'oven', 'stir':'spoon', 'microwave':'microwave', 'juice':'juicer', 'press':'press', 'grind':'grinder','toast':'toaster','boil':'stove', 'cut':'knife','slice':'knife','scoop':'spoon','peel':'peeler','whisk':'whisk','mash':'masher', 'grill':'grill'}
